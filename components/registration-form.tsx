...
export function RegistrationForm({ onUpdate, currentDevice, onConfirm, isConfirmed }: RegistrationFormProps) {
  ...
  return (
    <div className="glass-panel-gray rounded-[1.5rem] p-6 shadow-sm h-full flex flex-col justify-between overflow-hidden border border-black/10">
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-5">
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="w-full bg-white border-2 border-black/10 rounded-xl py-2.5 px-4 text-sm font-bold focus:ring-2 focus:ring-black/20 text-black outline-none shadow-sm transition-all"
            >
          ...
          <div className="space-y-1.5">
            ...
            <input
              className="w-full bg-white border-2 border-black/10 rounded-xl py-2.5 px-4 text-sm font-mono font-bold focus:ring-2 focus:ring-black/20 placeholder:text-black/15 outline-none shadow-sm text-black transition-all"
              placeholder="000-000"
        ...
        <div className="grid grid-cols-2 gap-5">
          <div className="space-y-1.5">
            ...
            <input
              className="w-full bg-white border-2 border-black/10 rounded-xl py-2.5 px-4 text-sm font-bold focus:ring-2 focus:ring-black/20 placeholder:text-black/15 outline-none shadow-sm text-black transition-all"
        ...
        <div className="grid grid-cols-2 gap-5">
          <div className="space-y-1.5">
            ...
            <input
              className="w-full bg-white border-2 border-black/10 rounded-xl py-2.5 px-4 text-xs font-mono font-bold focus:ring-2 focus:ring-black/20 placeholder:text-black/15 outline-none shadow-sm text-black transition-all"
              placeholder="00.0000"
